        ...
        <div class="container">
          ...
          <div class="links">
            <ul>
              ...
              <li>
                <a href="./buffet.php" class="active">Buffet</a>
              </li>
              <li>
    ...
    <section class="buffets" id="buffets">
      <div class="container">
        <div class="section-header">
          ...
          <h3 class="title" data-title="Nossos">Buffet's</h3>
                ...
                ?>
                    <div class="pro">
                      ...
                      <div class="des">
                        ...
                        <h4> R$<?php echo number_format($row['valorBuffet'], 2, ',', '.'); ?></h4>
