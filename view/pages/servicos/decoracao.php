...
$listDecoracao = $decoracao->listarTudo();
        ...
        <div class="container">
          ...
          <div class="links">
            <ul>
              ...
              <li>
                <a href="./decoracao.php" class="active">Decoração</a>
              </li>
              <li>
    ...
    <section class="buffets" id="buffets">
      <div class="container">
        <div class="section-header">
          ...
          <h3 class="title" data-title="Nossas">Decorações</h3>
                    ...
                    <div class="pro">
                      ...
                      <div class="des">
                        ...
                        <div class="star">
                          ...
                          <i>
                            <?php
                            $avgBuf = $item->avgAvaliacaoDecoracao($row['idDecoracao']);
                        ...
                        <h4> R$<?php echo number_format($row['valorDecoracao'], 2, ',', '.'); ?></h4>
