...
$listSeguranca = $seguranca->listarTudo();
        ...
        <div class="container">
          ...
          <div class="links">
            <ul>
              ...
              <li>
                <a href="./seguranca.php" class="active">Segurança</a>
              </li>
            </ul>
          </div>
    ...
    <section class="buffets" id="buffets">
      <div class="container">
        <div class="section-header">
          ...
          <h3 class="title" data-title="Nossas">Seguranças</h3>
                    ...
                    <div class="pro">
                      ...
                      <div class="des">
                        ...
                        <div class="star">
                          ...
                          <i>
                            <?php
                            $avgBuf = $item->avgAvaliacaoSeguranca($row['idSeguranca']);
                        ...
                        <h4> R$<?php echo number_format($row['valorSeguranca'], 2, ',', '.'); ?></h4>
