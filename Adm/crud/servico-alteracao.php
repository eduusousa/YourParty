...
<head>
    ...
    <title>Your Party - Alterar Serviço</title>
    <!-- ======= Styles ====== -->
        ...
        <div class="navigation">
            <ul>
                <li>
                    <a href="#">
                        <div class="icon">
                            <img src="../../../yourParty/privateWork/pages/dashboard/assets/img/balão.png" width="35px" heigh="35px">
                        </div>
        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <?php 
                        ...
                        $stmt =$pdo ->prepare("select idServico, nomeServico from tbServico");
                        $stmt ->execute();
                        
                    ?>
                        <form action="servico-alterar.php" method="post">
                            <input type="hidden" placeholder="idServico" name="txIdServico" value="<?php echo @$_GET['idServico'];?>" />
                            <input type="text" name="txServico" id="txServico" placeholder="Alterar Serviço" value="<?php echo @$_GET['nomeServico'];?>">
                            <button type="submit">
                                Alterar
                            </button>
                        </form>
            ...
            <table>
                    ...
                    while($row5 = $stmt5 ->fetch(PDO::FETCH_BOTH)) { ?>
                        <tr>
                            ...
                            <td> 
                                ...
                                <?php echo "<a href='?idServico=$row5[0]&nomeServico=$row5[1]'>Alterar</a>" ?>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
                ...
                <div class="recentCustomers">
                    ...
                    <table>
                    <?php 
                        $stmt5 = $pdo->prepare("SELECT nomeEmpresa,fotoEmpresa,emailEmpresa FROM tbEmpresa 
                        ...
                        while($row5 = $stmt5 ->fetch(PDO::FETCH_BOTH)){
                                echo '<td>';
                                    echo '<b><h4>Empresas: </b>'. $row5[0]. '<br> <b><span>Email: </b>'. $row5[2].'</span></h4>';
                                echo '</td>';
                            echo ('</tr>');
						}	
                    ?>
