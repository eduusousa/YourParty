...
<head>
    ...
    <link rel="stylesheet" href="../dashboard/assets/css/style-index-decoracao.css">
      <!-- ======= Styles ====== -->
      <link rel="stylesheet" href="../dashboard/assets/css/style.css">
                ...
                <section id="product1" class="section-p1">
                    ...
                    <div class="pro-container">
                        <div class="pro">
                            ...
                            <div class="des">
                                <span> DECORAÇÃO </span>
                                <h5>CADASTRE JÁ UMA DECORAÇÃO</h5>

                            </div>

                            <a href="form-decoracao-2.php"><input type="submit" value="Cadastrar" class="btn solid" name="logarCliente" /></a>
                        ...
                        <div class="pro">
                            ...
                            <div class="des">
                                <span> ÍTEM DO PACOTE DE DECORAÇÃO </span>
                                <h5>CADASTRE JÁ UM ÍTEM</h5>

                            </div>

                            <a href="form-item-decoracao-2.php"><input type="submit" value="Cadastrar" class="btn solid" name="logarCliente" /></a>
                        </div>
                    </div>
                </section>
            </section>
